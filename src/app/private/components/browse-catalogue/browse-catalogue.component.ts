...
export class BrowseCatalogueComponent {
  productList: ProductData[] = [
    ...
    {
      image: '../../../../assets/images/service-catalog-1.png',
      title : 'Ball Bearing Ball Bearing Ball Bearing Ball Bearing Ball Bearing all Bearing',
      discription : 'This Vacuum Pump encompasses four different types of mechanism for the engines above 2000 bhp. types of mechanism for the engines above 2000 bhp.',
      company : 'Hella KGaA Hueck & Co.  '
    },
  ];
